...
const UserInfo = ({ designation, name }) => {
  return (
    <div className="flex flex-col justify-between items-center mt-8">
      <img className="rounded-full h-[12rem] w-[12rem] object-cover" src={testimonalImg} alt="" />
...
const Testimonal = () => {
  ...
  const rightArr = ">";
  return (
    <div className="text-white bg-primary1 flex min-w-[100vw] mt-[12rem] px-4 py-[4rem] min-h-[90vh] flex-col justify-evenly items-center ">
