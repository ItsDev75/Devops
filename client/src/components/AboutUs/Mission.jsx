    ...
    >
      <div className="flex flex-col">
        <h1 className="font-bold tracking-wider">
          100<span className="text-primary1">M</span>
        </h1>
        <h3 className="text-lg">Client Satisfaction</h3>
      </div>
      <div className="flex flex-col">
        <h1 className="font-bold tracking-wider">
          24<span className="text-primary1">h</span>
        </h1>
        <h3 className="text-lg">Expert Support Team</h3>
      </div>
      <div className="flex flex-col">
        <h1 className="font-bold tracking-wider">
          98<span className="text-primary1"> k+</span>
        </h1>
        <h3 className="text-lg">Sales Count</h3>
      </div>
      <div className="flex flex-col">
        <h1 className="font-bold tracking-wider">
          208 <span className="text-primary1">+</span>
        </h1>
