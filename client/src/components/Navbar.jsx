  ...
  return (
    <div
      className={`sticky top-[1rem] z-[999] ${
        color ? "backdrop-blur-xl backdrop-brightness-90 bg-opacity-30 bg-secondary4" : ""
    ...
    >
      <div className="  grid col-span-12 items-center h-16  rounded-3xl w-[80%] m-auto">
        ...
        <div
          ...
          } py-[1.1rem] ml-4  ${color ? 'bg-opacity-60' : 'bg-opacity-25'}  col-start-4 col-end-7  rounded-[3rem] transition-all`}
        >
          <ul className="flex justify-evenly">
            <Link to="/about">About</Link>
            <Link to="/features">Features</Link>
            <Link to=" ">Team</Link>
            <Link to="https://join.slack.com/t/xerocodee-workspace/shared_invite/zt-1u40v2902-1YLQZsCLUw8bN9dHa3Zudw" target="_blank">Join</Link>
            <Link to="https://blog.xerocodee.com/" target="_blank">Blogs</Link>
          </ul>
        </div>
